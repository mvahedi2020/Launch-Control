...
| Timeline | Timeline page | Shows local timestamped decisions, changed-evidence snapshots, Go withdrawals after a required regression, and simulated responses | An unchanged focus/blur creates no event; the local trail is not an audit system |
