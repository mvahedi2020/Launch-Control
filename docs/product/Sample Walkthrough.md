...
Set **Support enablement state** to **Ready**. The Support runbook check unlocks. Mark **Support runbook rehearsed** complete and enter **Sample rehearsal notes** in its evidence field. These exact sample inputs clear the final required gate.
